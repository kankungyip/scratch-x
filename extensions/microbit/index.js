...
class MicroBit {
    ...
    constructor (extensionId) {
         ...
         */
        this._ble = null;
        Scratch.extensions.registerPeripheral(extensionId, this);
    ...
    scan () {
        ...
        this._ble = new WebBLE(this._extensionId, {
            filters: [
...
class Scratch3MicroBitBlocks {
    ...
    constructor () {
        ...
        this._peripheral = new MicroBit(Scratch3MicroBitBlocks.EXTENSION_ID);
    }
    ...
    _getTiltAngle (direction) {
        ...
        case MicroBitTiltDirection.RIGHT:
            return Math.round(this._peripheral.tiltX / 10);
        default:
            consloe.warn(`Unknown tilt direction in _getTiltAngle: ${direction}`);
        }
    }
